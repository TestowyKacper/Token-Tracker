...
<head>
  ...
  @include('nawigacja')
        ...
        <div class="alert alert-success alert-block">
          ...
          <div id="Sparent" style="border-bottom: 0px">
            <div id="Sprawa"><a role="button" href="{{'zaakceptowany/'.$item->id}}"  class="btn btn-success form-control">Zaakceptuj</a></div>
            <div id="Slewa"><a role="button" href="{{'odrzucony/'.$item->id}}"  class="btn btn-danger form-control">Odrzuć</a></div>
